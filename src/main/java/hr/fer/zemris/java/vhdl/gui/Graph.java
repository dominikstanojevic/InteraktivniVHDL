...
public class Graph {
    ...
    private VHDLComponent.Signal signal;
    ...
    public Graph(VHDLComponent.Signal signal, long startTime) {
    ...
    private JFreeChart createChart(XYDataset dataset) {
        final JFreeChart result = ChartFactory.createXYLineChart(null, "Seconds", "Value", dataset);
    ...
    public VHDLComponent.Signal getSignal() {
        return signal;
    }
